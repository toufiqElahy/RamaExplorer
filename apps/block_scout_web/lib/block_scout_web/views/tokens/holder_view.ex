defmodule BlockScoutWeb.Tokens.HolderView do
  ...
  """
  def format_token_balance_value(value, _id, %Token{type: "RAMA-20", decimals: decimals}) do
    format_according_to_decimals(value, decimals)
  end

  def format_token_balance_value(value, id, %Token{type: "RAMA-1155", decimals: decimals}) do
