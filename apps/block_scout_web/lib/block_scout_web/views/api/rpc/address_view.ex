defmodule BlockScoutWeb.API.RPC.AddressView do
  ...
  defp prepare_token_transfer(%{token_type: "RAMA-721"} = token_transfer) do
    token_transfer
    |> prepare_common_token_transfer()
    |> Map.put_new(:tokenID, token_transfer.token_id)
  end

  defp prepare_token_transfer(%{token_type: "RAMA-1155"} = token_transfer) do
    token_transfer
    |> prepare_common_token_transfer()
    |> Map.put_new(:tokenID, token_transfer.token_id)
  end

  defp prepare_token_transfer(%{token_type: "RAMA-20"} = token_transfer) do
    token_transfer
    |> prepare_common_token_transfer()
